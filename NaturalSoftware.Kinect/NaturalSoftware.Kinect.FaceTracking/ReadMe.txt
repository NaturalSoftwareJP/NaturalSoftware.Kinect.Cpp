========================================================================
    スタティック ライブラリ: NaturalSoftware.Kinect.Toolkit.FaceTracking プロジェクトの概要
========================================================================

この NaturalSoftware.Kinect.Toolkit.FaceTracking ライブラリ プロジェクトは、AppWizard により作成されました。

ソース ファイルはプロジェクトの一部として作成されませんでした。


NaturalSoftware.Kinect.Toolkit.FaceTracking.vcxproj
...
NaturalSoftware.Kinect.Toolkit.FaceTracking.vcxproj.filters
